...
WEATHER_PRESETS = {
    ...
    WeatherState.CLEAR: {
        ...
        "meteor_rate": 0.25,
        "mountain": 0.1,
        "possible_transitions": ["light_rain", "foggy", "windy_night", "firefly", "volcano", "mushroom", "leaves", "bloom"],
        "season_preference": 0.375,
        "transition_weights": [1, 1, 0.75, 0.5, 0.1, 0.2, 0.75, 0.75],
        "tree_prob": 1,
        "wind_speed": 0.2,
    },
...
WEATHER_SETS = {
    "cosmic_night": {
        ...
        "season_extremity": 1,
        "season_speed": 2,
        "states": ["clear", "windy_night", "thunderstorm", "sandstorm"],
        "transition_speed": 2,
    },
