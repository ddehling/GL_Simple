...
Usage:
    python tools/media/normalize_ambient_volumes.py                # dry-run, fan project
    python tools/media/normalize_ambient_volumes.py --target -18   # louder target
    python tools/media/normalize_ambient_volumes.py --write        # apply changes
    python tools/media/normalize_ambient_volumes.py --project ocean
