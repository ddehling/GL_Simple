...
Usage:
    python tools/media/tts_elevenlabs.py "Your text here"
    python tools/media/tts_elevenlabs.py "Your text here" --voice "Rachel" --output my_file.mp3
    python tools/media/tts_elevenlabs.py --list-voices
    python tools/media/tts_elevenlabs.py --batch texts.txt
...
OUTPUT_DIR = Path(__file__).resolve().parents[2] / "media" / "sounds"
