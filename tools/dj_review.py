...
seams sat on disk teaching nobody. This is the reader.
    ...
    python tools/dj_review.py                # every night on disk
    python tools/dj_review.py --last         # just the most recent night
    python tools/dj_review.py --since 7      # last 7 days
    python tools/dj_review.py --terms        # + selection-term validation
    python tools/dj_review.py --gates        # + why styles never reached the menu
    python tools/dj_review.py --skips        # + what the operator kept rejecting
    python tools/dj_review.py --all          # all sections
