...
Usage:
    python tools/_dj_theme_sim.py                     # all themes, 3x4h
    python tools/_dj_theme_sim.py --nights 2 --hours 3
    python tools/_dj_theme_sim.py --themes groove,peak_heavy,hard_drive
"""
import argparse
import os
import sys
...
def audit_levers(library, names):
    ...
    print("  stale: `python tools/dj_scan.py --retag` re-derives them.")
