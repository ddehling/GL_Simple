(() => {
  ...
  var require_dist = __commonJS({
    "node_modules/@tonaljs/pitch-distance/node_modules/@tonaljs/pitch/dist/index.js"(exports, module) {
      ...
      function pitch(coord) {
        const [f3, o, dir] = coord;
        const step = FIFTHS_TO_STEPS[unaltered(f3)];
        const alt = Math.floor((f3 + 1) / 7);
        if (o === void 0) {
          return { step, alt, dir };
        }
  ...
  var require_dist2 = __commonJS({
    "node_modules/@tonaljs/pitch-distance/node_modules/@tonaljs/pitch-interval/dist/index.js"(exports, module) {
      ...
      function interval(src) {
        return typeof src === "string" ? cache[src] || (cache[src] = parse5(src)) : (0, import_pitch.isPitch)(src) ? interval(pitchName(src)) : (0, import_pitch.isNamedPitch)(src) ? interval(src.name) : NoInterval;
      }
      var SIZES = [0, 2, 4, 5, 7, 9, 11];
      var TYPES = "PMMPPMM";
      function parse5(str) {
      ...
      function coordToInterval(coord, forceDescending) {
        const [f3, o = 0] = coord;
        const isDescending = f3 * 7 + o * 12 < 0;
        const ivl = forceDescending || isDescending ? [-f3, -o, -1] : [f3, o, 1];
        return interval((0, import_pitch.pitch)(ivl));
      }
      function qToAlt(type, q4) {
        return q4 === "M" && type === "majorable" || q4 === "P" && type === "perfectable" ? 0 : q4 === "m" && type === "majorable" ? -1 : /^A+$/.test(q4) ? q4.length : /^d+$/.test(q4) ? -1 * (type === "perfectable" ? q4.length : q4.length + 1) : 0;
      }
  ...
  var require_dist4 = __commonJS({
    "node_modules/@tonaljs/pitch-note/dist/index.js"(exports, module) {
      ...
      function note(src) {
        ...
        const value = typeof src === "string" ? parse5(src) : (0, import_pitch.isPitch)(src) ? note(pitchName(src)) : (0, import_pitch.isNamedPitch)(src) ? note(src.name) : NoNote;
  ...
  var require_dist5 = __commonJS({
    "node_modules/@tonaljs/pitch-distance/dist/index.js"(exports, module) {
      ...
      function distance(fromNote, toNote) {
        ...
        const to2 = (0, import_pitch_note.note)(toNote);
  ...
  var require_dist6 = __commonJS({
    "node_modules/@tonaljs/abc-notation/dist/index.js"(exports, module) {
      ...
      function distance(from, to2) {
        return (0, import_pitch_distance.distance)(abcToScientificNotation(from), abcToScientificNotation(to2));
      }
  ...
  var require_dist7 = __commonJS({
    "node_modules/@tonaljs/array/dist/index.js"(exports, module) {
      ...
      function sortedNoteNames(notes) {
        ...
        return valid.sort((a, b2) => a.height - b2.height).map((n) => n.name);
      }
    ...
    "node_modules/@tonaljs/pcset/dist/index.js"(exports, module) {
      ...
      function chromaToIntervals(chroma2) {
        ...
        for (let i2 = 0; i2 < 12; i2++) {
          if (chroma2.charAt(i2) === "1") intervals2.push(IVLS[i2]);
        }
        return intervals2;
      }
      function notes(set) {
      ...
      function chromaRotations(chroma2) {
        ...
        return binary.map((_3, i2) => (0, import_collection.rotate)(i2, binary).join(""));
      }
      ...
      function listToChroma(set) {
        ...
        for (let i2 = 0; i2 < set.length; i2++) {
          pitch = (0, import_pitch_note.note)(set[i2]);
          if (pitch.empty) pitch = (0, import_pitch_interval.interval)(set[i2]);
  ...
  var require_dist12 = __commonJS({
    "node_modules/@tonaljs/chord-detect/node_modules/@tonaljs/chord-type/dist/index.js"(exports, module) {
      ...
      dictionary.sort((a, b2) => a.setNum - b2.setNum);
  ...
  var require_dist13 = __commonJS({
    "node_modules/@tonaljs/chord-detect/dist/index.js"(exports, module) {
      ...
      function detect2(source, options = {}) {
        ...
        return found.filter((chord) => chord.weight).sort((a, b2) => b2.weight - a.weight).map((chord) => chord.name);
      }
      var BITMASK = {
        // 3m 000100000000
        // 3M 000010000000
  ...
  var require_dist18 = __commonJS({
    "node_modules/@tonaljs/core/dist/index.js"(exports, module) {
      ...
      var fillStr = (s, n) => Array(Math.abs(n) + 1).join(s);
      function deprecate(original, alternative, fn2) {
  ...
  var require_dist19 = __commonJS({
    "node_modules/@tonaljs/chord-type/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS(chord_type_exports);
      var import_core3 = require_dist18();
      var import_pcset = require_dist11();
      var CHORDS = [
        ["1P 3M 5P", "major", "M ^  maj"],
        ["1P 3M 5P 7M", "major seventh", "maj7 \u0394 ma7 M7 Maj7 ^7"],
      ...
      var chordType = (0, import_core3.deprecate)("ChordType.chordType", "ChordType.get", get);
      function names() {
        return dictionary.map((chord) => chord.name).filter((x) => x);
      }
      function symbols() {
      ...
      var entries = (0, import_core3.deprecate)("ChordType.entries", "ChordType.all", all);
      function removeAll() {
        dictionary = [];
        index = {};
      }
  ...
  var require_dist21 = __commonJS({
    "node_modules/@tonaljs/chord/dist/index.js"(exports, module) {
      ...
      function getChord(typeName, optionalTonic, optionalRoot) {
        ...
        const notes = tonic.empty ? [] : intervals.map((i2) => (0, import_core22.transpose)(tonic, i2));
      ...
      function degrees(chordName) {
        ...
        const transpose2 = (0, import_core3.tonicIntervalsTransposer)(intervals, tonic);
        return (degree) => degree ? transpose2(degree > 0 ? degree - 1 : degree) : "";
      }
      function steps(chordName) {
        const { intervals, tonic } = get(chordName);
        return (0, import_core3.tonicIntervalsTransposer)(intervals, tonic);
      }
      var chord_default = {
        getChord,
        get,
  ...
  var require_dist22 = __commonJS({
    "node_modules/@tonaljs/duration-value/dist/index.js"(exports, module) {
      ...
      var REGEX = /^([^.]+)(\.*)$/;
      function get(name) {
        const [_3, simple, dots] = REGEX.exec(name) || [];
  ...
  var require_dist23 = __commonJS({
    "node_modules/@tonaljs/interval/dist/index.js"(exports, module) {
      ...
      function simplify(name2) {
        const i2 = (0, import_pitch_interval.interval)(name2);
      ...
      function invert(name2) {
        ...
        return (0, import_pitch_interval.interval)({ step, alt, oct: i2.oct, dir: i2.dir }).name;
      }
      ...
      function fromSemitones(semitones2) {
        ...
        return d2 * (IN[c2] + 7 * o) + IQ[c2];
      }
      var distance = import_pitch_distance.distance;
      var add = combinator((a, b2) => [a[0] + b2[0], a[1] + b2[1]]);
      var addTo = (interval) => (other) => add(interval, other);
      var substract = combinator((a, b2) => [a[0] - b2[0], a[1] - b2[1]]);
  ...
  var require_dist24 = __commonJS({
    "node_modules/@tonaljs/midi/dist/index.js"(exports, module) {
      ...
      function pcsetFromMidi(midi) {
        return midi.map(chroma).sort((a, b2) => a - b2).filter((n, i2, a) => i2 === 0 || n !== a[i2 - 1]);
      }
      ...
      function pcsetNearest(notes) {
        ...
        return (midi) => {
          const ch2 = chroma(midi);
          for (let i2 = 0; i2 < 12; i2++) {
            if (set.includes(ch2 + i2)) return midi + i2;
            if (set.includes(ch2 - i2)) return midi - i2;
          }
          return void 0;
        };
  ...
  var require_dist25 = __commonJS({
    "node_modules/@tonaljs/note/dist/index.js"(exports, module) {
      ...
      var ascending = (a, b2) => a.height - b2.height;
      var descending = (a, b2) => b2.height - a.height;
  ...
  var require_dist28 = __commonJS({
    "node_modules/@tonaljs/roman-numeral/dist/index.js"(exports, module) {
      ...
      var cache = {};
      function get(src) {
        return typeof src === "string" ? cache[src] || (cache[src] = parse5(src)) : typeof src === "number" ? get(NAMES[src] || "") : (0, import_pitch.isPitch)(src) ? fromPitch(src) : (0, import_pitch.isNamedPitch)(src) ? get(src.name) : NoRomanNumeral;
      }
  ...
  var require_dist29 = __commonJS({
    "node_modules/@tonaljs/key/dist/index.js"(exports, module) {
      ...
      var distInFifths = (from, to2) => {
        const f3 = (0, import_pitch_note.note)(from);
        const t = (0, import_pitch_note.note)(to2);
        return f3.empty || t.empty ? 0 : t.coord[0] - f3.coord[0];
      };
      ...
      function majorKey(tonic) {
        const pc2 = (0, import_pitch_note.note)(tonic).pc;
        ...
        return {
          ...keyScale2,
          type: "major",
          minorRelative: (0, import_note.transpose)(pc2, "-3m"),
          alteration,
      ...
      function minorKey(tnc) {
        const pc2 = (0, import_pitch_note.note)(tnc).pc;
        if (!pc2) return NoMinorKey;
        const alteration = distInFifths("C", pc2) - 3;
        return {
          type: "minor",
          tonic: pc2,
          relativeMajor: (0, import_note.transpose)(pc2, "3m"),
          alteration,
          keySignature: (0, import_pitch_note.altToAcc)(alteration),
  ...
  var require_dist32 = __commonJS({
    "node_modules/@tonaljs/mode/node_modules/@tonaljs/interval/dist/index.js"(exports, module) {
      ...
      var add = combinator((a, b2) => [a[0] + b2[0], a[1] + b2[1]]);
      var addTo = (interval) => (other) => add(interval, other);
      var subtract = combinator((a, b2) => [a[0] - b2[0], a[1] - b2[1]]);
      function transposeFifths(interval, fifths) {
        const ivl = get(interval);
        if (ivl.empty) return "";
        const [nFifths, nOcts, dir] = ivl.coord;
    ...
    "node_modules/@tonaljs/mode/dist/index.js"(exports, module) {
      ...
      function chords(chords2) {
        return (modeName, tonic) => {
          ...
          const tonics = mode2.intervals.map((i2) => (0, import_pitch_distance.transpose)(tonic, i2));
      ...
      function distance(destination, source) {
        ...
        const to2 = get(destination);
        if (from.empty || to2.empty) return "";
        return (0, import_interval.simplify)((0, import_interval.transposeFifths)("1P", to2.alt - from.alt));
      }
  ...
  var require_dist38 = __commonJS({
    "node_modules/@tonaljs/progression/node_modules/@tonaljs/chord/dist/index.js"(exports, module) {
      ...
      function getChord(typeName, optionalTonic, optionalBass) {
        ...
        const notes2 = tonic.empty ? [] : intervals.map((i2) => (0, import_pitch_distance.transpose)(tonic.pc, i2));
        typeName = type.aliases.indexOf(typeName) !== -1 ? typeName : type.aliases[0];
  ...
  var require_dist42 = __commonJS({
    "node_modules/@tonaljs/scale/dist/index.js"(exports, module) {
      ...
      function tokenize(name) {
        ...
        const tonic = (0, import_pitch_note.note)(name.substring(0, i2));
        if (tonic.empty) {
      ...
      function get(src) {
        ...
        const type = st.name;
        const notes = tonic ? st.intervals.map((i2) => (0, import_pitch_distance.transpose)(tonic, i2)) : [];
      ...
      function modeNames(name) {
        ...
        return (0, import_pcset.modes)(s.chroma).map((chroma2, i2) => {
      ...
      function rangeOf(scale2) {
        ...
        return (fromNote, toNote) => {
          ...
          const to2 = (0, import_pitch_note.note)(toNote).height;
          if (from === void 0 || to2 === void 0) return [];
          return (0, import_collection.range)(from, to2).map(getName).filter((x) => x);
        };
      }
  ...
  var require_dist43 = __commonJS({
    "node_modules/@tonaljs/time-signature/dist/index.js"(exports, module) {
      ...
      var REGEX = /^(\d*\d(?:\+\d)*)\/(\d+)$/;
      var CACHE = /* @__PURE__ */ new Map();
      function get(literal2) {
        const stringifiedLiteral = JSON.stringify(literal2);
        const cached = CACHE.get(stringifiedLiteral);
        if (cached) {
          return cached;
        }
        const ts2 = build(parse5(literal2));
        CACHE.set(stringifiedLiteral, ts2);
        return ts2;
      }
      function parse5(literal2) {
        if (typeof literal2 === "string") {
          const [_3, up22, low] = REGEX.exec(literal2) || [];
          return parse5([up22, low]);
        }
        const [up2, down] = literal2;
        const denominator = +down;
        if (typeof up2 === "number") {
          return [up2, denominator];
        }
        const list2 = up2.split("+").map((n) => +n);
      ...
      function build([up2, down]) {
        const upper = Array.isArray(up2) ? up2.reduce((a, b2) => a + b2, 0) : up2;
        const lower = down;
        if (upper === 0 || lower === 0) {
          return NONE;
        }
  ...
  var require_minTopNoteDiff = __commonJS({
    "node_modules/chord-voicings/dist/minTopNoteDiff.js"(exports) {
      ...
      function minTopNoteDiff(voicings, lastVoicing) {
        ...
        return voicings.reduce(function(best, current2) {
          return diff(current2) < diff(best) ? current2 : best;
        }, voicings[0]);
      }
    ...
    "node_modules/estraverse/estraverse.js"(exports) {
      (function clone(exports2) {
        ...
        Controller.prototype.path = function path() {
          var i2, iz, j4, jz, result, element;
          function addToPath(result2, path2) {
            if (Array.isArray(path2)) {
              for (j4 = 0, jz = path2.length; j4 < jz; ++j4) {
                result2.push(path2[j4]);
              }
            } else {
              result2.push(path2);
            }
    ...
    "node_modules/esutils/lib/keyword.js"(exports, module) {
      (function() {
        ...
        function isIdentifierNameES5(id2) {
          ...
          if (!code.isIdentifierStartES5(ch2)) {
            return false;
          }
          for (i2 = 1, iz = id2.length; i2 < iz; ++i2) {
            ch2 = id2.charCodeAt(i2);
            if (!code.isIdentifierPartES5(ch2)) {
              return false;
            }
          }
          return true;
    ...
    "node_modules/source-map/lib/quick-sort.js"(exports) {
      ...
      function doQuickSort(ary, comparator, p2, r) {
        if (p2 < r) {
          ...
          swap(ary, i2 + 1, j4);
          var q4 = i2 + 1;
          doQuickSort(ary, comparator, p2, q4 - 1);
          doQuickSort(ary, comparator, q4 + 1, r);
        }
      }
      ...
      Object.defineProperty(IndexedSourceMapConsumer.prototype, "sources", {
        get: function() {
          ...
          for (var i2 = 0; i2 < this._sections.length; i2++) {
            for (var j4 = 0; j4 < this._sections[i2].consumer.sources.length; j4++) {
              sources.push(this._sections[i2].consumer.sources[j4]);
            }
          }
          return sources;
        }
    ...
    "node_modules/escodegen/escodegen.js"(exports) {
      (function() {
        ...
        function adjustMultilineComment(value, specialBase) {
          var array, i2, len, line, j4, spaces, previousBase, sn2;
          array = value.split(/\r\n|[\r\n]/);
          spaces = Number.MAX_VALUE;
          for (i2 = 1, len = array.length; i2 < len; ++i2) {
            line = array[i2];
            j4 = 0;
            while (j4 < line.length && esutils.code.isWhiteSpace(line.charCodeAt(j4))) {
              ++j4;
            }
            if (spaces > j4) {
              spaces = j4;
        ...
        function generateBlankLines(start, end, result) {
          var j4, newlineCount = 0;
          for (j4 = start; j4 < end; j4++) {
            if (sourceCode[j4] === "\n") {
              newlineCount++;
            }
          }
          for (j4 = 1; j4 < newlineCount; j4++) {
            result.push(newline);
          }
        }
  ...
  function newFraction(n, d2) {
    ...
    const f3 = Object.create(Fraction.prototype);
    f3["s"] = n < C_ZERO ? -C_ONE : C_ONE;
    n = n < C_ZERO ? -n : n;
    const a = gcd(n, d2);
    f3["n"] = n / a;
    f3["d"] = d2 / a;
  ...
  function factorize(n) {
    ...
    for (let si2 = 0, p2 = C_TWO + C_FIVE; p2 * p2 <= n; ) {
      while (n % p2 === C_ZERO) {
        add(p2);
        n /= p2;
      }
  ...
  var parse = function(p12, p2) {
    ...
    if (p12 === void 0 || p12 === null) {
      ...
      let ndx = 0;
      let v2 = C_ZERO, w3 = C_ZERO, x = C_ZERO, y = C_ONE, z4 = C_ONE;
  ...
  Fraction.prototype = {
    ...
    "toString": function(dec = 15) {
      let N3 = this["n"];
      let D3 = this["d"];
      let cycLen = cycleLen(N3, D3);
      let cycOff = cycleStart(N3, D3, cycLen);
  ...
  function Cn(t, e = 60) {
    let n = 0, s = m(0), r = [""], o = "";
    for (; r[0].length < e; ) {
      const i2 = t.queryArc(n, n + 1), a = i2.filter((h) => h.hasOnset()).map((h) => h.duration), u = Sn(...a), p2 = u.inverse();
      r = r.map((h) => h + "|"), o += "|";
      for (let h = 0; h < p2; h++) {
        const [y, g2] = [s, s.add(u)], v2 = i2.filter((O) => O.whole.begin.lte(y) && O.whole.end.gte(g2)), _3 = v2.length - r.length;
        _3 > 0 && (r = r.concat(Array(_3).fill(o))), r = r.map((O, A3) => {
          const I3 = v2[A3];
          if (I3) {
...
`);
  ...
  var f = class _f2 {
    ...
    appWhole(e, n) {
      const s = this, r = function(o) {
        const i2 = s.query(o), a = n.query(o), u = function(p2, h) {
          const y = p2.part.intersection(h.part);
          if (y != null)
            return new S(
              e(p2.whole, h.whole),
              y,
    ...
    appLeft(e) {
      const n = this, s = function(o) {
        ...
        for (const a of n.query(o)) {
          ...
          for (const p2 of u) {
            const h = a.whole, y = a.part.intersection(p2.part);
            if (y) {
              const g2 = a.value(p2.value), v2 = p2.combineContext(a), _3 = new S(h, y, g2, v2);
              i2.push(_3);
            }
          }
        }
    ...
    appRight(e) {
      const n = this, s = function(o) {
        ...
        for (const a of e.query(o)) {
          ...
          for (const p2 of u) {
            const h = a.whole, y = p2.part.intersection(a.part);
            if (y) {
              const g2 = p2.value(a.value), v2 = a.combineContext(p2), _3 = new S(h, y, g2, v2);
              i2.push(_3);
            }
          }
        }
    ...
    bindWhole(e, n) {
      const s = this, r = function(o) {
        const i2 = function(u, p2) {
          return new S(
            e(u.whole, p2.whole),
            p2.part,
            p2.value,
            Object.assign({}, u.context, p2.context, {
              locations: (u.context.locations || []).concat(p2.context.locations || [])
            })
          );
        }, a = function(u) {
          return n(u.value).query(o.setSpan(u.part)).map((p2) => i2(u, p2));
        };
    ...
    squeezeJoin() {
      ...
      function n(s) {
        ...
        function o(a) {
          const p2 = a.value._focusSpan(a.wholeOrPart()).query(s.setSpan(a.part));
          function h(y, g2) {
            let v2;
            if (g2.whole && y.whole && (v2 = g2.whole.intersection(y.whole), !v2))
              return;
            const _3 = g2.part.intersection(y.part);
            if (!_3)
              return;
            const O = g2.combineContext(y);
            return new S(v2, _3, g2.value, O);
          }
          return p2.map((y) => h(a, y));
        }
      ...
      return this.discreteOnly().withHaps((n) => {
        ...
        for (var r = 0; r < n.length; ++r) {
          for (var o = true, i2 = n[r]; o; ) {
            const p2 = JSON.stringify(n[r].value);
        ...
        get: function() {
          ...
          for (const a of e)
            i2[a.toLowerCase()] = function(...u) {
              var p2 = o;
              u = Q(u), r && (p2 = r(p2), u = r(u));
              var h;
              return n === "keepif" ? (h = p2["_op" + a](u, (y) => (g2) => s(y, g2)), h = h.removeUndefineds()) : h = p2["_op" + a](u, (y) => (g2) => Pn(y, g2, s)), h;
            };
  ...
  function l(t, e, n = true, s = false, r = (o) => o.innerJoin()) {
    ...
    n ? i2 = function(...u) {
      u = u.map(d);
      const p2 = u[u.length - 1];
      let h;
      if (o === 1)
        h = e(p2);
      else {
        const y = u.slice(0, -1);
        if (y.every((g2) => g2.__pure != null)) {
          const g2 = y.map((_3) => _3.__pure), v2 = y.filter((_3) => _3.__pure_loc).map((_3) => _3.__pure_loc);
          h = e(...g2, p2), h = h.withContext((_3) => {
            const O = (_3.locations || []).concat(v2);
            return { ..._3, locations: O };
          });
        } else {
          const [g2, ...v2] = y;
          let _3 = (...O) => e(...O, p2);
          _3 = w(_3, null, o - 1), h = r(v2.reduce((O, A3) => O.appLeft(A3), g2.fmap(_3)));
        }
      }
      return s && (h._steps = p2._steps), h;
    } : i2 = function(...u) {
      u = u.map(d);
      const p2 = e(...u);
      return s && (p2._steps = u[u.length - 1]._steps), p2;
      ...
      const p2 = e(...u, this);
      return s && p2.setSteps(this._steps), p2;
    });
    const a = w(i2, null, o);
    return le[t] = a, a;
  }
  ...
  var { fastGap: wd, fastgap: gd } = l(["fastGap", "fastgap"], function(t, e) {
    const n = function(r) {
      ...
      const o = r.part.begin, i2 = r.part.end, a = o.sam(), u = o.sub(a).div(t).min(1), p2 = i2.sub(a).div(t).min(1), h = new B(a.add(u), a.add(p2)), y = r.whole ? new B(
    ...
    function(t) {
      const e = function(n) {
        const s = n.span, r = s.begin.sam(), o = s.begin.nextSam(), i2 = function(u) {
          const p2 = u.withTime((y) => r.add(o.sub(y))), h = p2.begin;
  ...
  function $(...t) {
    ...
    if (t = t.map(e), t.find((i2) => i2[0] === void 0)) {
      ...
      if (i2.length === t.length)
        return R;
      const a = i2.reduce((u, p2) => u.add(p2), m(0)).div(i2.length);
      for (let u of t)
        u[0] === void 0 && (u[0] = a);
    }
    if (t.length == 1)
  ...
  var de = (t, e, n) => {
    ...
    const s = m(1).div(t.length), r = (a) => {
      const u = [];
      for (const [p2, h] of a.entries())
        h && u.push([m(p2).div(a.length), h]);
      return u;
    }, o = Pt(
      ([a, u], [p2, h]) => {
        const y = n.mul(p2 - a).add(a), g2 = y.add(s);
        return new B(y, g2);
      },
      r(t),
      r(e)
    ...
    function i2(a) {
      const u = a.span.begin.sam(), p2 = a.span.cycleArc(), h = [];
      for (const y of o) {
        const g2 = y.intersection(p2);
        g2 !== void 0 && h.push(
          new S(
            y.withTime((v2) => v2.add(u)),
            g2.withTime((v2) => v2.add(u)),
            true
          )
        );
      }
  ...
  function Nt(t) {
    ...
    const n = t[0], s = (o) => {
      ...
      if (typeof o == "object" && o.value !== void 0 && (i2 = { ...o }, o = o.value, delete i2.value), e && Array.isArray(o)) {
        const a = i2 || {};
        return o.forEach((u, p2) => {
          p2 < t.length && (a[t[p2]] = u);
        }), a;
  ...
  function V(t, e, ...n) {
    ...
    for (let r = 1; r <= e; r++) {
      let o = [...n], i2 = [...t];
      if (r === 1) {
        const u = o.map((h) => `${h}1`), p2 = i2.map((h) => `${h}1`);
        o = o.concat(u).concat(p2);
      } else
  ...
  f.prototype.modulate = function(t, e, n) {
    ...
    for (const [i2, a] of Object.entries(e)) {
      const u = tf(t, i2), p2 = d(a);
      r = r.fmap(({ v: h, id: y }) => (g2) => {
        if (o === void 0) {
          let _3 = yt(Object.keys(h).at(-1));
          s.includes(_3) && (_3 = `${_3}_${[...h[_3].__ids].at(-1)}`), o = _3;
        }
        h[t] ??= { __ids: /* @__PURE__ */ new Set() };
        const v2 = h[t];
        return y ??= v2.__ids.size, v2[y] ??= { control: o }, v2.__ids.add(y), g2 === void 0 ? { v: h, id: y } : (u === "control" || u === "subControl" ? v2[y][u] = yt(g2) : v2[y][u] = g2, { v: h, id: y });
      }).appLeft(p2);
    }
  ...
  function ff(t, e, n = 0.05, s = 0.1, r = 0.1, o = globalThis.setInterval, i2 = globalThis.clearInterval, a = true) {
    let u = 0, p2 = 0, h = 10 ** 4, y = 0.01;
    const g2 = (x) => n = x(n);
    r = r || s / 2;
    const v2 = () => {
      const x = t(), D3 = x + s + r;
      for (p2 === 0 && (p2 = x + y); p2 < D3; )
        p2 = a ? Math.round(p2 * h) / h : p2, e(p2, n, u, x), p2 += n, u++;
    };
    let _3;
    const O = () => {
      A3(), v2(), _3 = o(v2, s * 1e3);
    }, A3 = () => {
      _3 !== void 0 && i2(_3), _3 = void 0;
    };
    return { setDuration: g2, start: O, stop: () => {
      u = 0, p2 = 0, A3();
    }, pause: () => A3(), duration: n, interval: s, getPhase: () => p2, minLatency: y };
  }
  var hf = class {
    constructor({
      interval: e,
      ...
      this.started = false, this.beforeStart = p2, this.cps = 0.5, this.num_ticks_since_cps_change = 0, this.lastTick = 0, this.lastBegin = 0, this.lastEnd = 0, this.getTime = o, this.num_cycles_at_cps_change = 0, this.seconds_at_cps_change, this.onToggle = s, this.latency = i2, this.clock = ff(
        o,
        ...
        (h, y, g2, v2) => {
          ...
          try {
            ...
            this.pattern.queryArc(A3, I3, { _cps: this.cps, cyclist: "cyclist" }).forEach((P3) => {
              if (P3.hasOnset()) {
                const x = (P3.whole.begin - this.num_cycles_at_cps_change) / this.cps + this.seconds_at_cps_change + i2, D3 = P3.duration / this.cps, nt = x - h;
                n?.(P3, nt, D3, this.cps, x), P3.value.cps !== void 0 && this.cps != P3.value.cps && (this.cps = P3.value.cps, this.num_ticks_since_cps_change = 0);
              }
            });
          } catch (A3) {
            zt(A3), r?.(A3);
      ...
      const n = function(s) {
        ...
        for (const a of o) {
          ...
          if (u === 0)
            ...
            !r || s.span.begin.lt(y.midpoint()) ? p2 = y.begin : p2 = y.end;
          }
          r && (ct[u] = p2, u !== 0 && delete ct[-u]);
          const h = e.late(p2).query(s.setSpan(a.part)).map((y) => y.setContext(y.combineContext(a)));
          i2.push(...h);
        }
        return i2;
      };
  ...
  var bf = class {
    constructor({ onTrigger: e, onToggle: n, getTime: s }) {
      ...
      const r = (i2) => {
        const { cps: a, begin: u, end: p2, cycle: h, time: y } = i2;
        this.cps = a, this.cycle = h;
        const g2 = this.collator.calculateOffset(y) + y;
        o(u, p2, g2), this.time_at_last_tick_message = g2;
      }, o = (i2, a, u) => {
        if (this.started === false)
          return;
        this.pattern.queryArc(i2, a, { _cps: this.cps, cyclist: "neocyclist" }).forEach((h) => {
          if (h.hasOnset()) {
            const g2 = Kt(h.whole.begin - this.cycle, this.cps) + u + this.latency, v2 = Kt(h.duration, this.cps);
            e?.(h, 0, v2, this.cps, g2);
          }
        });
      };
  ...
  function Dy({
    ...
    const O = new SalatRepl({ localScope: true }), A3 = {
      ...
      Object.assign(A3, b2), A3.isDirty = A3.code !== A3.activeCode, A3.error = A3.evalError || A3.schedulerError, p2?.(A3);
    }, P3 = {
      onTrigger: Sf({ defaultOutput: t, getTime: o }),
      getTime: o,
      onToggle: (b2) => {
        H3({ started: b2 }), qf(b2), a?.(b2), b2 || df();
      },
      setInterval: y,
      clearInterval: g2,
      beforeStart: s
    ...
    let D3 = {}, nt = 0, tt;
    const Vt = function() {
      return D3 = {}, nt = 0, tt = void 0, q;
    }, Je = (b2) => O.evaluate(b2).compile({ log: false });
    function Ht(b2) {
      return b2._Pattern ? b2.__pure : b2;
    }
    const Dt = async (b2, k3 = true) => (b2 = u?.(b2) || b2, await x.setPattern(b2, k3), vf(b2), b2);
    ee(() => x.now());
    ...
    const We = function(b2) {
      ...
      f.prototype.p = function(k3) {
        return typeof k3 == "string" && (k3.startsWith("_") || k3.endsWith("_")) ? q : (k3.includes("$") && (k3 = `${k3}${nt}`, nt++), D3[k3] = this, this);
    ...
    return { scheduler: x, evaluate: async (b2, k3 = true, At = true) => {
      if (!b2)
        throw new Error("no code to evaluate");
      try {
        H3({ code: b2, pending: true }), await Ie(), ee(() => x.now()), await n?.({ code: b2 }), ft = [], At && Vt(), _3 && (b2 = `mondolang\`${b2}\``);
        let { pattern: M, meta: Tt } = await On(b2, i2, I3);
        if (Object.keys(D3).length) {
          let X2 = [], ht = false;
          for (const [st, Ve] of Object.entries(D3)) {
    ...
    }, start: Ne, stop: $e, pause: Le, setCps: St, setPattern: Dt, setCode: (b2) => H3({ code: b2 }), toggle: Re, state: A3 };
  }
  ...
  var Ee = function(t, ...e) {
    ...
    const o = En(s), i2 = function(a) {
      const u = r.mul(a);
      return o.fmap((p2) => (h) => n[p2.findIndex((y) => y > h, p2)]).appLeft(u);
    };
    return t.bind(i2);
  };
  ...
  function Vf(t, e = 0) {
    ...
    const r = (p2) => 6 * p2 ** 5 - 15 * p2 ** 4 + 10 * p2 ** 3, o = (p2) => (h) => (y) => h + r(p2) * (y - h), i2 = K(n, 1, e), a = K(s, 1, e);
    return o(t - n)(i2)(a);
  }
  function Hf(t, e = 0) {
    const n = Math.floor(t), s = n + 1, r = K(n, 1, e), o = K(s, 1, e), i2 = r + o, a = (t - n) / (s - n);
    return ((p2, h, y) => p2 + y * (h - p2))(r, i2, a) / 2;
  }
  ...
  var Hw = function(t, e = {}) {
    ...
    n.style = s;
    const { className: r } = n, o = (u, p2) => {
      ({
        style: () => n.style = s + ";" + p2,
        className: () => n.className = p2 + " " + r
      })[u]();
    }, i2 = Object.entries(e).filter(([u, p2]) => typeof p2 == "function");
    Object.entries(e).filter(([u, p2]) => typeof p2 == "string").forEach(([u, p2]) => o(u, p2)), i2.length;
  };
  var Dw = () => {
...
Please check with "npm ls @strudel/core".`
  ...
  function uu2(t, i2, e, f3) {
    var l2 = Error.call(this, t);
    return Object.setPrototypeOf && Object.setPrototypeOf(l2, uu2.prototype), l2.expected = i2, l2.found = e, l2.location = f3, l2.name = "SyntaxError", l2;
  }
  Or2(uu2, Error);
  function Cu2(t, i2, e) {
  ...
  uu2.prototype.format = function(t) {
    ...
    if (this.location) {
      ...
      for (f3 = 0; f3 < t.length; f3++)
        if (t[f3].source === this.location.source) {
          e = t[f3].text.split(/\r\n|\n|\r/g);
          break;
        }
      var l2 = this.location.start, a = this.location.source && typeof this.location.source.offset == "function" ? this.location.source.offset(l2) : l2, D3 = this.location.source + ":" + a.line + ":" + a.column;
      if (e) {
        var v2 = this.location.end, g2 = Cu2("", a.line.toString().length, " "), c2 = e[l2.line - 1], F3 = l2.line === v2.line ? v2.column : c2.length + 1, p2 = F3 - l2.column || 1;
        i2 += `
 --> ` + D3 + `
` + g2 + ` |
` + a.line + " | " + c2 + `
` + g2 + " | " + Cu2("", l2.column - 1, " ") + Cu2("", p2, "^");
      } else
        i2 += `
 at ` + D3;
    }
  ...
  uu2.buildMessage = function(t, i2) {
    var e = {
      ...
      class: function(c2) {
        var F3 = c2.parts.map(function(p2) {
          return Array.isArray(p2) ? a(p2[0]) + "-" + a(p2[1]) : a(p2);
        });
    ...
    function v2(c2) {
      var F3 = c2.map(D3), p2, w3;
      if (F3.sort(), F3.length > 0) {
        for (p2 = 1, w3 = 1; p2 < F3.length; p2++)
          F3[p2 - 1] !== F3[p2] && (F3[w3] = F3[p2], w3++);
        F3.length = w3;
      }
      switch (F3.length) {
        case 1:
...
`], true, false), rt2 = _3("cat", false), nt = _3("$", false), st = _3("setcps", false), it2 = _3("setbpm", false), ft = _3("hush", false), ot2 = function() {
      ...
      return new hu2("hush");
    }, n = i2.peg$currPos | 0, $2 = n, V3 = [{ line: 1, column: 1 }], q4 = n, fu2 = i2.peg$maxFailExpected || [], h = i2.peg$silentFails | 0, eu2;
    if (i2.startRule) {
    ...
    function Ht() {
      var u;
      return t.charCodeAt(n) === 46 ? (u = D3, n++) : (u = e, h === 0 && d2(Ru2)), u;
    }
    function Jt2() {
      var u;
    ...
    function Qt() {
      var u, r, s, o, B4;
      if (u = n, r = Kt2(), r !== e) {
        if (s = t.charAt(n), Fe.test(s) ? n++ : (s = e, h === 0 && d2($e)), s === e && (s = null), o = [], B4 = X2(), B4 !== e)
          for (; B4 !== e; )
            o.push(B4), B4 = X2();
        else
          o = e;
    ...
    function er2() {
      var u;
      return t.charCodeAt(n) === 45 ? (u = v2, n++) : (u = e, h === 0 && d2(me2)), u;
    }
    function tr2() {
      var u;
      return t.charCodeAt(n) === 48 ? (u = g2, n++) : (u = e, h === 0 && d2(_e2)), u;
    }
    function X2() {
      var u;
    ...
    function Xu2() {
      var u, r, s, o;
      return u = n, r = E3(), t.charCodeAt(n) === 46 ? (s = D3, n++) : (s = e, h === 0 && d2(Ru2)), s !== e ? (o = E3(), r = [r, s, o], u = r) : (n = u, u = e), u;
    }
    function Y3() {
      var u;
    ...
    function rr2() {
      var u, r, s, o;
      return u = n, E3(), t.charCodeAt(n) === 91 ? (r = p2, n++) : (r = e, h === 0 && d2(Ou2)), r !== e ? (E3(), s = Ju2(), s !== e ? (E3(), t.charCodeAt(n) === 93 ? (o = w3, n++) : (o = e, h === 0 && d2(Mu2)), o !== e ? (E3(), $2 = u, u = ct2(s)) : (n = u, u = e)) : (n = u, u = e)) : (n = u, u = e), u;
    }
    function nr2() {
      var u, r, s, o, B4;
      return u = n, E3(), t.charCodeAt(n) === 123 ? (r = P3, n++) : (r = e, h === 0 && d2(Pe2)), r !== e ? (E3(), s = Ku2(), s !== e ? (E3(), t.charCodeAt(n) === 125 ? (o = R4, n++) : (o = e, h === 0 && d2(qe2)), o !== e ? (B4 = sr2(), B4 === e && (B4 = null), E3(), $2 = u, u = At(s, B4)) : (n = u, u = e)) : (n = u, u = e)) : (n = u, u = e), u;
    }
    function sr2() {
      var u, r, s;
      return u = n, t.charCodeAt(n) === 37 ? (r = su2, n++) : (r = e, h === 0 && d2(je2)), r !== e ? (s = H3(), s !== e ? ($2 = u, u = pt2(s)) : (n = u, u = e)) : (n = u, u = e), u;
    }
    function ir2() {
      var u, r, s, o;
    ...
    function ar2() {
      var u, r, s, o, B4, x, j4;
      return u = n, t.charCodeAt(n) === 40 ? (r = se3, n++) : (r = e, h === 0 && d2(Me2)), r !== e ? (E3(), s = tu2(), s !== e ? (E3(), o = G4(), o !== e ? (E3(), B4 = tu2(), B4 !== e ? (E3(), G4(), E3(), x = tu2(), x === e && (x = null), E3(), t.charCodeAt(n) === 41 ? (j4 = ie3, n++) : (j4 = e, h === 0 && d2(ze2)), j4 !== e ? ($2 = u, u = Bt2(s, B4, x)) : (n = u, u = e)) : (n = u, u = e)) : (n = u, u = e)) : (n = u, u = e)) : (n = u, u = e), u;
    }
    function lr2() {
      var u, r, s;
      return u = n, t.charCodeAt(n) === 47 ? (r = fe2, n++) : (r = e, h === 0 && d2(Te2)), r !== e ? (s = H3(), s !== e ? ($2 = u, u = Ct2(s)) : (n = u, u = e)) : (n = u, u = e), u;
    }
    function cr2() {
      var u, r, s;
      return u = n, t.charCodeAt(n) === 42 ? (r = oe3, n++) : (r = e, h === 0 && d2(Ze2)), r !== e ? (s = H3(), s !== e ? ($2 = u, u = Dt(s)) : (n = u, u = e)) : (n = u, u = e), u;
    }
    function Ar2() {
      var u, r, s;
    ...
    function pr2() {
      var u, r, s;
      return u = n, t.charCodeAt(n) === 58 ? (r = le3, n++) : (r = e, h === 0 && d2(Ue2)), r !== e ? (s = H3(), s !== e ? ($2 = u, u = Et2(s)) : (n = u, u = e)) : (n = u, u = e), u;
    }
    function gr2() {
      var u, r, s;
      return u = n, t.substr(n, 2) === Eu2 ? (r = Eu2, n += 2) : (r = e, h === 0 && d2(Ve)), r !== e ? (s = H3(), s !== e ? ($2 = u, u = vt2(s)) : (n = u, u = e)) : (n = u, u = e), u;
    }
    function tu2() {
      var u, r, s, o;
      if (u = n, r = H3(), r !== e) {
    ...
    function Hu2() {
      var u, r, s, o, B4;
      if (u = n, r = [], s = n, o = G4(), o !== e ? (B4 = T3(), B4 !== e ? s = B4 : (n = s, s = e)) : (n = s, s = e), s !== e)
        for (; s !== e; )
          r.push(s), s = n, o = G4(), o !== e ? (B4 = T3(), B4 !== e ? s = B4 : (n = s, s = e)) : (n = s, s = e);
      else
        r = e;
    ...
    function Fr2() {
      var u, r, s, o, B4;
      if (u = n, r = [], s = n, o = Vu2(), o !== e ? (B4 = T3(), B4 !== e ? s = B4 : (n = s, s = e)) : (n = s, s = e), s !== e)
        for (; s !== e; )
          r.push(s), s = n, o = Vu2(), o !== e ? (B4 = T3(), B4 !== e ? s = B4 : (n = s, s = e)) : (n = s, s = e);
      else
        r = e;
    ...
    function hr2() {
      var u, r, s, o, B4;
      if (u = n, r = [], s = n, o = Xu2(), o !== e ? (B4 = T3(), B4 !== e ? s = B4 : (n = s, s = e)) : (n = s, s = e), s !== e)
        for (; s !== e; )
          r.push(s), s = n, o = Xu2(), o !== e ? (B4 = T3(), B4 !== e ? s = B4 : (n = s, s = e)) : (n = s, s = e);
      else
        r = e;
    ...
    function Ju2() {
      var u, r, s;
      return u = n, r = T3(), r !== e ? (s = Hu2(), s === e && (s = Fr2(), s === e && (s = hr2())), s === e && (s = null), $2 = u, u = bt2(r, s)) : (n = u, u = e), u;
    }
    function Ku2() {
      var u, r, s;
      return u = n, r = T3(), r !== e ? (s = Hu2(), s === e && (s = null), $2 = u, u = xt2(r, s)) : (n = u, u = e), u;
    }
    function Br2() {
      var u, r, s, o;
    ...
    function Dr2() {
      var u, r, s;
      return u = n, t.substr(n, 6) === vu2 ? (r = vu2, n += 6) : (r = e, h === 0 && d2(Ge)), r !== e ? (E3(), s = J4(), s !== e ? ($2 = u, u = kt2(s)) : (n = u, u = e)) : (n = u, u = e), u;
    }
    function dr2() {
      var u, r, s, o, B4;
      return u = n, t.substr(n, 6) === $u2 ? (r = $u2, n += 6) : (r = e, h === 0 && d2(Ye2)), r !== e ? (E3(), s = Y3(), s !== e ? (o = Gu2(), o !== e ? (B4 = Y3(), B4 !== e ? ($2 = u, u = Nt2(o)) : (n = u, u = e)) : (n = u, u = e)) : (n = u, u = e)) : (n = u, u = e), u;
    }
    function Er2() {
      var u, r, s, o;
      ...
      if (u = n, t.substr(n, 5) === xu2 ? (r = xu2, n += 5) : (r = e, h === 0 && d2(et2)), r !== e)
        if (E3(), s = Y3(), s !== e) {
          if (o = [], B4 = au2(), B4 !== e)
            ...
            o = e;
          o !== e ? (B4 = Y3(), B4 !== e ? ($2 = u, u = Lt2(o)) : (n = u, u = e)) : (n = u, u = e);
        } else
          n = u, u = e;
      else
        n = u, u = e;
    ...
    function wr2() {
      var u, r, s, o, B4, x, j4, K2;
      if (u = n, t.substr(n, 3) === ku2 ? (r = ku2, n += 3) : (r = e, h === 0 && d2(rt2)), r !== e)
        if (E3(), t.charCodeAt(n) === 91 ? (s = p2, n++) : (s = e, h === 0 && d2(Ou2)), s !== e)
          if (E3(), o = J4(), o !== e) {
            for (B4 = [], x = n, j4 = G4(), j4 !== e ? (K2 = J4(), K2 !== e ? ($2 = x, x = Tu2(o, K2)) : (n = x, x = e)) : (n = x, x = e); x !== e; )
              B4.push(x), x = n, j4 = G4(), j4 !== e ? (K2 = J4(), K2 !== e ? ($2 = x, x = Tu2(o, K2)) : (n = x, x = e)) : (n = x, x = e);
            x = E3(), t.charCodeAt(n) === 93 ? (j4 = w3, n++) : (j4 = e, h === 0 && d2(Mu2)), j4 !== e ? ($2 = u, u = Ot2(o, B4)) : (n = u, u = e);
          } else
            n = u, u = e;
        else
          n = u, u = e;
    ...
    function J4() {
      ...
      if (u = n, r = br2(), r !== e) {
        ...
        n = u, u = e;
      return u === e && (u = n, r = Cr2(), r !== e ? (E3(), t.charCodeAt(n) === 36 ? (s = Ae2, n++) : (s = e, h === 0 && d2(nt)), s !== e ? (o = E3(), B4 = J4(), B4 !== e ? ($2 = u, u = zt2(r, B4)) : (n = u, u = e)) : (n = u, u = e)) : (n = u, u = e)), u;
    }
    function xr2() {
      var u, r;
      return u = n, r = J4(), r !== e && ($2 = u, r = Tt(r)), u = r, u === e && (u = Fu2()), u;
    }
    function Ir2() {
      var u;
      return u = xr2(), u;
    ...
    throw eu2 !== e && n < t.length && d2(Gt()), Yt2(
      fu2,
      q4 < t.length ? t.charAt(q4) : null,
      q4 < t.length ? gu2(q4, q4 + 1) : gu2(q4, q4)
    );
  }
  var Gr2 = [
    "start"
  ...
  function I(t, i2) {
    ...
    const f3 = U2(t, i2);
    return e.n = t / f3, e.d = i2 / f3, e;
  }
  function Q2(t) {
    const i2 = {};
    let e = t, f3 = ru2, l2 = Du2 - m2;
    for (; l2 <= e; ) {
      for (; e % f3 === C2; )
        e /= f3, i2[f3] = (i2[f3] || C2) + m2;
      l2 += m2 + ru2 * f3++;
    }
    return e !== t ? e > 1 && (i2[e] = (i2[e] || C2) + m2) : i2[t] = (i2[t] || C2) + m2, i2;
  }
  var k = function(t, i2) {
    let e = C2, f3 = m2, l2 = m2;
    if (t != null) if (i2 !== void 0) {
      ...
      if ("d" in t && "n" in t)
        e = BigInt(t.n), f3 = BigInt(t.d), "s" in t && (e *= BigInt(t.s));
      else if (0 in t)
        e = BigInt(t[0]), 1 in t && (f3 = BigInt(t[1]));
      ...
      if (t < 0 && (l2 = -m2, t = -t), t % 1 === 0)
        ...
        let a = 1, D3 = 0, v2 = 1, g2 = 1, c2 = 1, F3 = 1e7;
        for (t >= 1 && (a = 10 ** Math.floor(1 + Math.log10(t)), t /= a); v2 <= F3 && c2 <= F3; ) {
          let p2 = (D3 + g2) / (v2 + c2);
          if (t === p2) {
            v2 + c2 <= F3 ? (e = D3 + g2, f3 = v2 + c2) : c2 > v2 ? (e = g2, f3 = c2) : (e = D3, f3 = v2);
            break;
          } else
            t > p2 ? (D3 += g2, v2 += c2) : (g2 += D3, c2 += v2), v2 > F3 ? (e = g2, f3 = c2) : (e = D3, f3 = v2);
        }
        e = BigInt(e) * BigInt(a), f3 = BigInt(f3);
      }
    } else if (typeof t == "string") {
      let a = 0, D3 = C2, v2 = C2, g2 = C2, c2 = m2, F3 = m2, p2 = t.replace(/_/g, "").match(/\d+|./g);
      if (p2 === null)
        throw Z2();
      if (p2[a] === "-" ? (l2 = -m2, a++) : p2[a] === "+" && a++, p2.length === a + 1 ? v2 = z2(p2[a++], l2) : p2[a + 1] === "." || p2[a] === "." ? (p2[a] !== "." && (D3 = z2(p2[a++], l2)), a++, (a + 1 === p2.length || p2[a + 1] === "(" && p2[a + 3] === ")" || p2[a + 1] === "'" && p2[a + 3] === "'") && (v2 = z2(p2[a], l2), c2 = N2 ** BigInt(p2[a].length), a++), (p2[a] === "(" && p2[a + 2] === ")" || p2[a] === "'" && p2[a + 2] === "'") && (g2 = z2(p2[a + 1], l2), F3 = N2 ** BigInt(p2[a + 1].length) - m2, a += 3)) : p2[a + 1] === "/" || p2[a + 1] === ":" ? (v2 = z2(p2[a], l2), c2 = z2(p2[a + 2], m2), a += 3) : p2[a + 3] === "/" && p2[a + 1] === " " && (D3 = z2(p2[a], l2), v2 = z2(p2[a + 2], l2), c2 = z2(p2[a + 4], m2), a += 5), p2.length <= a)
        f3 = c2 * F3, l2 = /* void */
        e = g2 + f3 * D3 + F3 * v2;
      else
        throw Z2();
    ...
    if (f3 === C2)
      throw du2();
    A.s = l2 < C2 ? -m2 : m2, A.n = e < C2 ? -e : e, A.d = f3 < C2 ? -f3 : f3;
  };
  function Tr2(t, i2, e) {
    let f3 = m2;
  ...
  function Wr2(t, i2, e) {
    let f3 = m2, l2 = Tr2(N2, e, i2);
    for (let a = 0; a < 300; a++) {
      if (f3 === l2)
        return BigInt(a);
      f3 = f3 * N2 % i2, l2 = l2 * N2 % i2;
    }
    return 0;
  }
  function U2(t, i2) {
  ...
  b.prototype = {
    ...
    pow: function(t, i2) {
      ...
      let e = Q2(this.n), f3 = Q2(this.d), l2 = m2, a = m2;
      for (let D3 in e)
        if (D3 !== "1") {
          if (D3 === "0") {
            l2 = C2;
    ...
    log: function(t, i2) {
      ...
      const e = {}, f3 = Q2(A.n), l2 = Q2(A.d), a = Q2(this.n), D3 = Q2(this.d);
      for (const c2 in l2)
        f3[c2] = (f3[c2] || C2) - l2[c2];
      for (const c2 in D3)
        a[c2] = (a[c2] || C2) - D3[c2];
      for (const c2 in f3)
        c2 !== "1" && (e[c2] = true);
      ...
      for (const c2 in e) {
        ...
        let w3 = p2, P3 = F3;
        const R4 = U2(w3, P3);
        if (w3 /= R4, P3 /= R4, v2 === null && g2 === null)
          v2 = w3, g2 = P3;
        else if (w3 * g2 !== v2 * P3)
          return null;
      }
      return v2 !== null && g2 !== null ? I(v2, g2) : null;
    },
    /**
     * Check if two rational numbers are the same
     *
    ...
    roundTo: function(t, i2) {
      k(t, i2);
      const e = this.n * A.d, f3 = this.d * A.n, l2 = e % f3;
      let a = S2(e / f3);
      return l2 + l2 >= f3 && a++, I(this.s * a * A.n, A.d);
    },
    /**
     * Check if two rational numbers are divisible
     *
    ...
    toString: function(t) {
      ...
      t = t || 15;
      let f3 = Zr2(i2, e), l2 = Wr2(i2, e, f3), a = this.s < C2 ? "-" : "";
      if (a += S2(i2 / e), i2 %= e, i2 *= N2, i2 && (a += "."), f3) {
        for (let D3 = l2; D3--; )
    ...
    toFraction: function(t) {
      let i2 = this.n, e = this.d, f3 = this.s < C2 ? "-" : "";
      if (e === m2)
        f3 += i2;
      else {
        let l2 = S2(i2 / e);
        t && l2 > C2 && (f3 += l2, f3 += " ", i2 %= e), f3 += i2, f3 += "/", f3 += e;
      }
      return f3;
    },
    /**
    ...
    toLatex: function(t) {
      ...
      if (e === m2)
        ...
        let l2 = S2(i2 / e);
        t && l2 > C2 && (f3 += l2, i2 %= e), f3 += "\\frac{", f3 += i2, f3 += "}{", f3 += e, f3 += "}";
      }
      return f3;
    },
    /**
    ...
    simplify: function(t) {
      const i2 = BigInt(1 / (t || 1e-3) | 0), e = this.abs(), f3 = e.toContinued();
      for (let l2 = 1; l2 < f3.length; l2++) {
        let a = I(f3[l2 - 1], m2);
        for (let v2 = l2 - 2; v2 >= 0; v2--)
          a = a.inverse().add(f3[v2]);
        let D3 = a.sub(e);
        if (D3.n * i2 < D3.d)
          return a.mul(this.s);
      }
  ...
  var L2 = class _L {
    ...
    withCycle(i2) {
      const e = this.begin.sam(), f3 = e.add(i2(this.begin.sub(e))), l2 = e.add(i2(this.end.sub(e)));
      return new _L(f3, l2);
    }
    intersection(i2) {
      const e = this.begin.max(i2.begin), f3 = this.end.min(i2.end);
      if (!e.gt(f3) && !(e.equals(f3) && (e.equals(this.end) && this.begin.lt(this.end) || e.equals(i2.end) && i2.begin.lt(i2.end))))
        return new _L(e, f3);
    }
    intersection_e(i2) {
  ...
  var cu2 = (...t) => {
    ...
    const i2 = t.pop();
    return t.reduce(
      (e, f3) => e === void 0 || f3 === void 0 ? void 0 : e.lcm(f3),
      i2
    );
  };
  W2._original = b;
  var ue2 = 3e-4;
  var Vr2 = (t, i2) => (e, f3) => {
    const D3 = t.source_[f3].options_?.ops, v2 = e.__steps_source;
    if (D3)
      for (const g2 of D3)
        switch (g2.type_) {
          case "stretch": {
            const c2 = ["fast", "slow"], { type: F3, amount: p2 } = g2.arguments_;
            if (!c2.includes(F3))
          ...
          case "replicate": {
            const { amount: c2 } = g2.arguments_;
            e = d(e), e = e._repeatCycles(c2)._fast(c2);
            break;
          }
          case "bjorklund": {
            g2.arguments_.rotation ? e = e.euclidRot(i2(g2.arguments_.pulse), i2(g2.arguments_.step), i2(g2.arguments_.rotation)) : e = e.euclid(i2(g2.arguments_.pulse), i2(g2.arguments_.step));
            break;
          }
          case "degradeBy": {
            e = d(e)._degradeByWith(W.early(ue2 * g2.arguments_.seed), g2.arguments_.amount ?? 0.5);
            break;
          }
          case "tail": {
            const c2 = i2(g2.arguments_.element);
            e = e.fmap((F3) => (p2) => Array.isArray(F3) ? [...F3, p2] : [F3, p2]).appLeft(c2);
            break;
          }
          case "range": {
            const c2 = i2(g2.arguments_.element);
            e = d(e);
            const F3 = (w3, P3, R4 = 1) => Array.from(
              { length: Math.abs(P3 - w3) / R4 + 1 },
              (su2, iu2) => w3 < P3 ? w3 + iu2 * R4 : w3 - iu2 * R4
            );
            e = ((w3, P3) => w3.squeezeBind((R4) => P3.bind((su2) => N(...F3(R4, su2)))))(e, c2);
            break;
          }
          default:
            console.warn(`operator "${g2.type_}" not implemented`);
        }
    return e.__steps_source = e.__steps_source || v2, e;
  };
  function nu2(t, i2, e, f3 = 0) {
    e?.(t);
    const l2 = (a) => nu2(a, i2, e, f3);
    switch (t.type_) {
      case "pattern": {
        const a = t.source_.map((c2) => l2(c2)).map(Vr2(t, l2)), D3 = t.arguments_.alignment, v2 = a.filter((c2) => c2.__steps_source);
        let g2;
        switch (D3) {
          case "stack": {
            g2 = z(...a), v2.length && (g2._steps = cu2(...v2.map((c2) => W2(c2._steps))));
            break;
          }
          case "polymeter_slowcat": {
            g2 = z(...a.map((c2) => c2._slow(c2.__weight))), v2.length && (g2._steps = cu2(...v2.map((c2) => W2(c2._steps))));
            break;
          }
          case "polymeter": {
            const c2 = t.arguments_.stepsPerCycle ? l2(t.arguments_.stepsPerCycle).fmap((p2) => m(p2)) : C(m(a.length > 0 ? a[0].__weight : 1)), F3 = a.map((p2) => p2.fast(c2.fmap((w3) => w3.div(p2.__weight))));
            g2 = z(...F3);
            break;
          }
          case "rand": {
            g2 = Pe(W.early(ue2 * t.arguments_.seed).segment(1), a), v2.length && (g2._steps = cu2(...v2.map((c2) => W2(c2._steps))));
            break;
          }
          case "feet": {
            g2 = N(...a);
          ...
          default: {
            if (t.source_.some((F3) => !!F3.options_?.weight)) {
              const F3 = t.source_.reduce(
                (p2, w3) => p2.add(w3.options_?.weight || m(1)),
                m(0)
              );
              g2 = ns(
                ...t.source_.map((p2, w3) => [p2.options_?.weight || m(1), a[w3]])
              ), g2.__weight = F3, g2._steps = F3, v2.length && (g2._steps = g2._steps.mul(cu2(...v2.map((p2) => W2(p2._steps)))));
            } else
              g2 = Q(...a), g2._steps = a.length;
            t.arguments_._steps && (g2.__steps_source = true);
          }
        }
        return v2.length && (g2.__steps_source = true), g2;
      }
      case "element":
        return l2(t.source_);
      case "atom": {
        ...
        if (f3 === -1)
          return C(a);
        const [D3, v2] = ee2(i2, t, f3);
        return C(a).withLoc(D3, v2);
      }
      case "stretch":
  ...
  var ee2 = (t, i2, e = 0) => {
    const { start: f3, end: l2 } = i2.location_, a = t?.split("").slice(f3.offset, l2.offset).join(""), [D3 = 0, v2 = 0] = a ? a.split(i2.source_).map((g2) => g2.split("").filter((c2) => c2 === " ").length) : [];
    return [f3.offset + D3 + e, l2.offset - v2 + e];
  };
  var Au2 = (t, i2 = 0, e = t) => {
    try {
      return Mr2(t);
    } catch (f3) {
      const l2 = [f3.location.start.offset + i2, f3.location.end.offset + i2], a = e.slice(0, l2[0]).split(`
`).length;
      throw new Error(`[mini] parse error at line ${a}: ${f3.message}`);
    }
  };
  var Xr2 = (t, i2, e) => {
    const f3 = Au2(t, i2, e);
  ...
  var Yr2 = (t, i2 = 0, e) => Xr2(t, i2, e).map((f3) => ee2(t, f3, i2));
  var te2 = (...t) => {
    const i2 = t.map((e) => {
      const f3 = `"${e}"`, l2 = Au2(f3);
      return nu2(l2, f3);
    });
    return Q(...i2);
  };
  ...
  var o1 = (m3) => {
    const [M, ...P3] = m3.split("");
    return t1.indexOf(M.toLowerCase()) + P3.reduce((t, e) => t + n1[e], 0);
  };
  function d1(m3) {
    const M = (m3 || "").match(/^([A-G][b#]*)([^/]*)[/]?([A-G][b#]*)?$/);
    return M ? M.slice(1) : [];
  }
  var S3 = (m3) => m3 % 12;
  var R2 = (m3) => {
    let M = Number(m3);
    return isNaN(M) ? import_tonal.Interval.semitones(m3) : M;
  };
  var G2 = (m3, M) => {
    if (typeof m3 == "number")
      return m3;
  ...
  var r1 = (m3, M = false) => {
    ...
    return (M ? e1 : P1)[m3 % 12] + P3;
  };
  function s1(m3, M, P3 = 1) {
    m3 = m3.map((e) => typeof e == "string" ? gt(e) : e);
    const t = Math.floor(M / m3.length) * P3 * 12;
    return M = bt(M, m3.length), m3[M] + t;
  }
  function U3(m3, M, P3) {
    let t = 0, e = 1 / 0;
    return M.forEach((n, s) => {
      const o = Math.abs(n - m3);
      (!P3 && o < e || P3 && o <= e) && (t = s, e = o);
    }), t;
  }
  var j2 = {};
  function c1(m3, M, P3, t) {
    const [e, n] = import_tonal.Scale.tokenize(M), s = G2(e), o = S3(s);
    if (!j2[n]) {
    ...
    if (P3) {
      P3 = G2(P3, 3);
      const a = S3(P3), l2 = bt(a - o, 12), y = U3(l2, d2, t);
      m3 = m3 + y, i2 = P3 - l2;
    }
    const c2 = Math.floor(m3 / d2.length) * 12;
    return m3 = bt(m3, d2.length), d2[m3] + i2 + c2;
  }
  var H = {
  ...
  function i1({ chord: m3, dictionary: M, offset: P3 = 0, n: t, mode: e = "below", anchor: n = "c5", octaves: s = 1 }) {
    const [o, d2] = d1(m3), i2 = o1(o);
    n = G2(n?.note || n, 4);
    const c2 = S3(n), r = M[d2].map(
      (u) => (typeof u == "string" ? u.split(" ") : u).map(R2)
    );
    let a, l2, y = r.map((u, $2) => {
      const X2 = H[e](u), E3 = bt(c2 - X2 - i2, 12);
      return (a === void 0 || E3 < a) && (a = E3, l2 = $2), E3;
    });
    e === "root" && (l2 = 0);
    const A3 = Math.ceil(P3 / r.length) * 12, N3 = bt(l2 + P3, r.length), x = r[N3], K2 = H[e](x), Q4 = n - y[N3] + A3, z4 = x.map((u) => Q4 - K2 + u);
    let V3 = z4.map((u) => r1(u));
    return e === "duck" && (V3 = V3.filter((u, $2) => z4[$2] !== n)), t !== void 0 ? [s1(V3, t, s)] : V3;
  }
  var a1 = (m3) => (m3 <= 0 ? -1 : 1) + m3 * 7 + "P";
  function _(m3) {
    m3 = m3.replaceAll(":", " ");
    const M = import_tonal.Scale.get(m3), { tonic: P3, empty: t } = M;
    if (t && Mt(m3) || t && !P3)
      throw new Error(
  ...
  function l1(m3, M) {
    m3 = Math.ceil(m3);
    let { intervals: P3, tonic: t } = _(M);
    t = t || "C";
    const { pc: e, oct: n = 3 } = import_tonal.Note.get(t), s = Math.floor(m3 / P3.length), o = bt(m3, P3.length), d2 = import_tonal.Interval.add(P3[o], a1(s));
    return import_tonal.Note.transpose(e + n, d2);
  }
  function J2(m3, M, P3) {
    let { notes: t } = _(m3);
    if (t = t.map((r) => import_tonal.Note.get(r).pc), M = Number(M), isNaN(M))
      throw new Error(`scale offset "${M}" not a number`);
    const { pc: e, oct: n = 3 } = import_tonal.Note.get(P3), s = t.indexOf(e);
    if (s === -1)
      throw new Error(`note "${P3}" is not in scale "${m3}"`);
    let o = s, d2 = n, i2 = e;
    const c2 = Math.sign(M);
    for (; Math.abs(o - s) < Math.abs(M); ) {
      o += c2;
      const r = bt(o, t.length);
      c2 < 0 && i2[0] === "C" && (d2 += c2), i2 = t[r], c2 > 0 && i2[0] === "C" && (d2 += c2);
    }
    return i2 + d2;
  }
  var { transpose: D1, trans: I1 } = l(["transpose", "trans"], function(M, P3) {
    return P3.withHap((t) => {
      ...
      if (typeof e != "string" || !Mt(e))
        return E(`[tonal] transpose: not a note "${e}"`, "warning"), t;
    ...
    function(m3, M) {
      return M.withHap((P3) => {
        ...
        if (typeof P3.value == "object")
          return P3.withValue(() => ({
            ...P3.value,
            note: J2(P3.context.scale, Number(m3), P3.value.note)
          }));
        if (typeof P3.value != "string")
          throw new Error("can only use scaleTranspose with notes");
        return P3.withValue(() => J2(P3.context.scale, Number(m3), P3.value));
      });
    }
  );
  function u1(m3) {
    let M = Number(m3), P3 = 0;
    if (isNaN(M)) {
      m3 = String(m3);
  ...
  var k2 = {};
  function f1(m3, M, P3 = true) {
    let t = typeof M == "string" ? gt(M) : M;
    if (k2[m3] === void 0) {
      const { intervals: r, tonic: a } = _(m3), { pc: l2 } = import_tonal.Note.get(a), A3 = r.concat("8P").map((x) => import_tonal.Note.transpose(l2 + "0", x)), N3 = A3.map(gt);
      k2[m3] = [N3, A3];
    }
    const [e, n] = k2[m3], s = e[0], o = Math.floor((t - s) / 12), d2 = e.map((r) => r + 12 * o), i2 = U3(t, d2, P3), c2 = n[i2];
    return import_tonal.Note.transpose(c2, import_tonal.Interval.fromSemitones(12 * o));
  }
  var k1 = l(
    "scale",
    function(m3, M) {
      return Array.isArray(m3) && (m3 = m3.flat().join(" ")), M.withHaps((P3) => (P3 = P3.map((t) => {
        let e = t.value;
        const n = typeof e == "object";
        e = n ? e : { n: e };
        const { note: s, n: o, value: d2, ...i2 } = e, c2 = s ?? o ?? d2;
        if (c2 === void 0)
          return E(
        ...
        let r;
        if (Mt(c2))
          r = f1(m3, c2), t.value = { ...i2, note: r };
        else
          try {
            const [a, l2] = u1(c2);
            i2.anchor ? r = c1(a, m3, i2.anchor) : r = l1(a, m3), l2 != 0 && (r = import_tonal.Note.transpose(r, import_tonal.Interval.fromSemitones(l2)));
          } catch (a) {
            zt(a, "tonal");
            return;
          }
        return t.value = n ? { ...i2, note: r } : r, t.setContext({ ...t.context, scale: m3 });
      }), lt(P3)));
    },
    true,
    true
  ...
  var W3 = "ireal";
  var y1 = (m3) => W3 = m3;
  var T1 = (m3, M) => A1(m3, v[m3].dictionary, M);
  var A1 = (m3, M, P3 = ["F3", "A4"]) => {
    Object.assign(v, { [m3]: { dictionary: M, range: P3 } });
  };
  var q2 = (m3, M, P3 = {}) => {
    Object.assign(v, { [m3]: { dictionary: M, ...P3 } });
  };
  var N1 = (m3, M, P3) => {
  ...
  var C3;
  var S1 = l("voicings", function(m3, M) {
    return M.fmap((P3) => (C3 = N1(P3, m3, C3), z(...C3))).outerJoin();
  });
  var G1 = l("rootNotes", function(m3, M) {
    return M.fmap((P3) => {
      const n = (P3.chord || P3).match(/^([a-gA-G][b#]?).*$/)[1] + m3;
      return P3.chord ? { note: n } : n;
    });
  });
  var F1 = l("voicing", function(m3) {
    return m3.fmap((M) => {
      M = typeof M == "string" ? { chord: M } : M;
      let { dictionary: P3 = W3, chord: t, anchor: e, offset: n, mode: s, n: o, octaves: d2, ...i2 } = M;
      P3 = typeof P3 == "string" ? v[P3] : { dictionary: P3, mode: "below", anchor: "c5" };
      try {
        let c2 = i1({ ...P3, chord: t, anchor: e, offset: n, mode: s, n: o, octaves: d2 });
        return z(...c2).note().set(i2);
      } catch {
        return E(`[voicing]: unknown chord "${t}"`), q;
      }
    }).outerJoin();
  });
  function D(m3, M, P3) {
  ...
  pp$9.catchStackOverflow = function(f3) {
    try {
      return f3();
    } catch (e) {
  ...
  function F2(e, t = {}) {
    const { wrapAsync: n = false, addReturn: a = true, emitMiniLocations: i2 = true, emitWidgets: p2 = true } = t, f3 = [];
    let l2 = parse4(e, {
      ecmaVersion: 2022,
    ...
    walk(l2, {
      enter(r, x) {
        ...
        if (U4(r, x)) {
          ...
          return this.skip(), i2 && b2(u, r), this.replace(T2(u, r));
        }
        if (G3(r)) {
          if (q3(r.start, m3))
            return;
          const { value: s } = r;
          return this.skip(), i2 && b2(s, r), this.replace(T2(s, r));
        }
        if (X(r))
          return p2 && y.push({
        ...
        if (Y2(r)) {
          ...
          return p2 && y.push(o), this.replace(te3(r, o));
        }
        if (re2(r, x))
      ...
      leave(r, x, s, u) {
        ...
        const { template: C4, patternExprs: k3 } = B3(o);
        if (k3.length) {
          const d2 = [{ type: "Literal", value: C4 }, ...k3, ...h];
          let L3 = r.callee;
        ...
        let w3 = r.callee;
        return w3.type === "ChainExpression" && (w3 = w3.expression), w3.type === "MemberExpression" ? this.replace({
          type: "CallExpression",
          callee: W4(w3.object),
          arguments: M,
          optional: false
    ...
    let { body: g2 } = l2;
    if (!g2.length)
      console.warn("empty body -> fallback to silence"), g2.push({
    ...
    else if (!g2?.[g2.length - 1]?.expression)
      throw new Error("unexpected ast format without body expression");
    if (a) {
      const { expression: r } = g2[g2.length - 1];
      g2[g2.length - 1] = {
    ...
    return n && (v2 = `(async ()=>{${v2}})()`), i2 ? { output: v2, miniLocations: c2, widgets: y } : { output: v2 };
  }
  function R3(e) {
  ...
  function B3(e) {
    ...
    return a.forEach(({ node: l2 }, m3) => {
      p2 = z3(l2, V2(m3), n, p2);
    }), { template: S4(p2), patternExprs: i2 };
  }
  function J3(e) {
    if (H2(e)) {
  ...
  function z3(e, t, n, a) {
    ...
    if (!i2 || !i2.parent)
      return t;
    const { parent: p2, prop: f3, index: l2 } = i2;
    return Array.isArray(p2[f3]) ? p2[f3][l2] = t : p2[f3] = t, n.set(t, { parent: p2, prop: f3, index: l2 }), a;
  }
  function I2(e) {
  ...
  function ce2(e, t) {
    ...
    for (const i2 of e) {
      ...
      if (p2.startsWith("mini-off"))
        a.push(i2.start);
      else if (p2.startsWith("mini-on")) {
        const f3 = a.pop();
        n.push([f3, i2.end]);
      }
    }
  ...
  // entry.mjs
  globalThis.__strudel = { core: dist_exports, mini: dist_exports2, tonal: dist_exports3, transpiler: F2 };
})();
