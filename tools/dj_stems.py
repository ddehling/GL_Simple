...
Usage:
    python tools/dj_stems.py                 # render all missing
    python tools/dj_stems.py --limit 10
    python tools/dj_stems.py --force         # re-render everything
    python tools/dj_stems.py --stats         # coverage + disk usage
"""
import argparse
import os
import sys
