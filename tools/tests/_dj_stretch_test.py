...
(tools/tests/_club_signals_test.run) on the output: detected BPM must equal
...
Usage:
    python tools/tests/_dj_stretch_test.py           # ALL PASS gate
    python tools/tests/_dj_stretch_test.py --wav     # also write ear-check WAVs
"""
import os
import sys
import time
