...
Usage:
    python tools/_dj_quality_test.py                # both parts, gate
    python tools/_dj_quality_test.py --audit-only
    python tools/_dj_quality_test.py --wav          # dump seam WAVs to logs/
"""
import os
import sys
