...
Usage:
    python tools/dj_structure.py                 # label all unlabeled
    python tools/dj_structure.py --limit 20
    python tools/dj_structure.py --force         # re-label everything
    python tools/dj_structure.py --stats         # coverage report
"""
import argparse
import json
import os
