...
Modes:
    ...
    python tools/dj_player.py --live [--theme groove] [--minutes 30]

    # Render an autonomous set to WAV (faster than realtime, no device):
    python tools/dj_player.py --wav out.wav --minutes 12 [--theme peak_heavy]
    ...
    python tools/dj_player.py --audition "trackA.mp3" "trackB.mp3" [--wav seam.wav]

    # Single file through a deck at a rate (stretch ear-check):
    python tools/dj_player.py --file song.mp3 --rate 1.06 [--wav out.wav]
