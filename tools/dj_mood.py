...
Usage:
    python tools/dj_mood.py                 # score all un-scored tracks
    python tools/dj_mood.py --limit 20
    python tools/dj_mood.py --force         # re-score everything
    python tools/dj_mood.py --stats         # coverage report
"""
import argparse
import os
import sys
