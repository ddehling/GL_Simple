...
Usage:
    python tools/_dj_persona_sim.py                       # 6h x 6 nights each
    python tools/_dj_persona_sim.py --nights 8 --hours 4
    python tools/_dj_persona_sim.py --personas neutral,monk,showman
"""
import argparse
import json
import os
