...
WEATHER_PRESETS = {
    ...
    WeatherState.FOREST_DAWN: {
        ...
        "possible_transitions": ["forest_morning", "first_frost", "pollen_drift"],
        "season_preference": 0.22,
        "starryness": 0.25,
        "transition_duration": 25,
        "transition_weights": [1, 0.25, 0.4],
        "tree_prob": 0.6,
        "wind_speed": 0.15,
    },
    ...
    WeatherState.FOREST_MIDDAY: {
        ...
        "godray_strength": 0.7,
        "possible_transitions": ["forest_dusk", "forest_storm", "autumn_blaze"],
        "season_preference": 0.5,
        "starryness": 0,
        "transition_duration": 25,
        "transition_weights": [1, 0.3, 0.4],
    ...
    WeatherState.FOREST_MORNING: {
        ...
        "godray_strength": 1,
        "possible_transitions": ["forest_midday", "forest_storm", "pollen_drift"],
        "season_preference": 0.42,
        "starryness": 0,
        "transition_duration": 25,
        "transition_weights": [1, 0.25, 0.5],
        "tree_prob": 0.8,
        "wind_speed": 0.2,
    },
...
WEATHER_SETS = {
    ...
    "desert_realm": {
        ...
        "background_events": ["desert_sky", "desert_mountains", "desert_dunes", "desert_creatures", "sandstorm", "stars", "clouds", "fog", "firefly", "desert_rain", "background_director"],
