...
WEATHER_SETS = {
    ...
    "peaceful_forest": {
        ...
        "background_events": ["clouds", "firefly", "stars", "rain", "fog", "forest_canopy", "canopy_godrays", "dappled_shadows", "snowfall", "spore_drift", "stream_flow", "forest_eyes", "forest_birds", "forest_bioluminescence"],
        "cycle_labels": ["Midnight", "Dawn", "Noon", "Dusk"],
